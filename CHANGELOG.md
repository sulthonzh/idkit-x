...
### Added
- Snowflake sequence overflow spin-wait test covering lines 180-181 (Date.now mock freezes time for 4096 IDs then advances)
- Coverage: statements 99.15%→100%, branches 96.07%→98.03%, lines→100%
